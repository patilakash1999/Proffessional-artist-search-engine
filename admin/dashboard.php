...
<head>
	...
	<title>Professional Artist Search Engine | Dashboard</title>
...
<table border="2" align="center" width="80%" style="">
	<tr>
		...
		<th style="color:green;text-align:center;font-size:16px">Approved</th>
	</tr>
...
$rt = mysqli_query($con,"SELECT count(complaintNumber) as totalcomplaint, 
   ...
   COUNT(IF((status='Approved'),0, NULL))  as closed,
...
?>
	...
	<tr>
		...
		<th style="color:#000;text-align:center; font-size:14px;"><a href="notprocess-listing.php"><?php echo $row['notprocessedyet'];?></a></th>
		<th style="color:#000;text-align:center;font-size:14px"><a href="inprocess-listing.php"><?php echo $row['inprocess'];?></a></th>
		
		<th style="color:#000;text-align:center;font-size:14px"><a href="approved-listing.php"><?php echo $row['closed'];?></a></th>
	</tr>
<?php } ?>
</table>
