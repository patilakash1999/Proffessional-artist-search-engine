...
<html lang="en">
  <head>
    ...
    <title>Professional Artist Search Engine | Listing Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Listing Details</h3>
            <hr />
