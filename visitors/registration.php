...
if(isset($_POST['submit']))
{
	...
	$status=0;
	$query=mysqli_query($con,"insert into visitors(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')");
...
<html lang="en">
  <head>
    ...
    <title>Professional Artist Search Engine | User Registration</title>
  ...
  <body>
	...
	<hr />
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Visitors Registration</h2>
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <input type="password" class="form-control" placeholder="Password" required="required" name="password"><br >
		             <input type="text" class="form-control" pattern="[6789][0-9]{9}" maxlength="10" min="10" name="contactno" placeholder="Contact no" required="required" autofocus>
		            <br>
