...
<html lang="en">
  <head>
    ...
    <title>Professional Artist Search Engine | Request History</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Your Request History</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
...
<?php } ?>
                                   <td align="center">
                                   <a href="listing-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
